...
###
# Disclaimer. Right now, this bot is still in BETA. Stuff might be broken, fires and explosions could happen, debris will probably fall on you too. Use it at your own risks, don't Give out your parrword to ANYONE. ***DO NOT GIVE 
# +n TO ANYONE, THEY CAN DELETE EVERYTHING ON YOUR BOT*** Read about eggdrop flags and how to use them on eggheads.org Here: http://www.eggheads.org/support/egghtml/1.6.16/users.html
## Setup
#***YOU HAVE STUFF TO EDIT BELOW HERE*** ***YOU HAVE STUFF TO EDIT BELOW HERE*** ***YOU HAVE STUFF TO EDIT BELOW HERE***
# Set the cmdchr here, (trigger) that will be used in front of commands For example, if you set it to "!" All commands will be prefixed by ! like !op !kick !ban.. If you don't change it, it will be .op .kick .bab
set cc(cmdchar) "."
# This is your channel, the public one, where everyone goes to.
set cc(mainchan) "#mainchan"
# Set the back channel, this channel will have modes +s set automatically Unless you change it in the next setting. If ever !ops is used, the people in there will receive the notice. When bans, kicks and other channel 
# manipulation is done, it will be sent in this channel. Note: The command INVITEME will invite you in this channel. useful if +i
set cc(backchan) "#secretchan"
# This is the mode that will be set by the bot in your backchannel from the setting above. Usually, +i, +s or +p is ok.
set cc(backmode) "+s"
# ***You don't have to edit anything beyond this point. *** ***You don't have to edit anything beyond this point. *** ***You don't have to edit anything beyond this point. ***
...
#End of pub_do_op pub_do_op:msg
...
#end of pub_do_deop voice event
...
#End of pub_do_voice Devoice someone
...
#end of pub_do_devoice Change topic on channel
...
#end of pub_do_topic Permban someone
...
#End of pub_do_kick Delete a host from the banlist.
...
#end of pub_do_unban Remove user from shitlist
...
#end of banlist Set the bot away.
...
#end of pub_do_away Set the bot back.
proc pub_do_back {nick host handle channel testes} {
	putserv "AWAY :"
	putserv "NOTICE $nick :I'm back."
}
#end of pub_do_back Change the mode in the channel
...
#end of pub_do_mode Set the rehash
...
set hopondeop 1
# Set this to 1 if the bot should kick those who deop it upon returning, 0 if not. NOTE: The bot owner will be immune to this kick even if it is enabled.
set kickondeop 1
...
# End - join/part botnick - small routine to bot to change nicks.
...
proc ctcp:reply {nick host hand dest 
key text} {
	global cc
	global replyctcp
...
#End of uptime addchattr with flags
